...
LoggerResults = read.csv("C:/Data Repositry/Elspec/TestResults/TEST215/PQSExport_20150218_100915_Ne02b_Wave.csv", header=T)
...
write.csv(LoggerResults, file= "C:/Data Repositry/Elspec/TestResults/Test215Results.csv")