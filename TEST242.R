...
LoggerResults = read.csv("C:/Data Repositry/Elspec/TestResults/TEST158/PQSExport_20150216_161545_Ne02b_Wave.csv", header=T)
...
StartTime <- as.POSIXct("2015-02-16 16:16:9.5", format = "%Y-%m-%d %H:%M:%OS", tz = "UTC")
EndTime <- as.POSIXct("2015-02-16 16:16:13.5", format = "%Y-%m-%d %H:%M:%OS", tz = "UTC")
...
write.csv(LoggerResults, file= "C:/Data Repositry/Elspec/TestResults/Test158Results.csv")