...
LoggerResults = read.csv("C:/Data Repositry/Elspec/TestResults/TEST161/PQSExport_20150217_093625_Ne02b_Wave.csv", header=T)
...
StartTime <- as.POSIXct("2015-02-17 09:36:50.8", format = "%Y-%m-%d %H:%M:%OS", tz = "UTC")
EndTime <- as.POSIXct("2015-02-17 09:36:54.4", format = "%Y-%m-%d %H:%M:%OS", tz = "UTC")
...
write.csv(LoggerResults, file= "C:/Data Repositry/Elspec/TestResults/Test161Results.csv")